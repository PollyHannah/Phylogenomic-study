...
2. Pairwise align the file with the .gb (Genbank Full) file in GenBank, for the same genome. Check each annotation and decide to either keep it as-is or edit it. 
