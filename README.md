...
#### Steps to take
1. Export the MSA file generated by OrthoFinder and drag and drop it into Geneious Prime.
2. Check each file and make edits where neccessary. 
3. Create a directory in the mcv directory named 3_orthofinder.
4. Save all the manually curated MSA files for all genomes as .fasta files in the 3_orthofinder directory. 
