...
A file containing all re-annotated sequences combined can be found in this repository called [`2_genomes_post_stop_codon_check`](https://github.com/PollyHannah/Phylogenomic-study/tree/main/annotation_check/2_genomes_post_stop_codon_check). Just drag and drop the .gb file into Geneious prime to load all 73 re-annotated genomes included in this study. 
...
* [`alignments_family_muscle_edited_trimmed_concatenation`](https://github.com/PollyHannah/Phylogenomic-study/tree/main/alignments_family_muscle_edited_trimmed_concatenation) (contains alignments for 23 genes)
