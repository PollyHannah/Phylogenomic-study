...
4. Create a directory in the prokka_outputs directory names 2_prokka_manual. Save all the manually curated proteome files for all genomes as .faa files in the new directory. 
