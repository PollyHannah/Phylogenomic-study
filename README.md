...
To understand how I made decisions as part of step 3 above, and which annotations I checked and edited for each genome, see directory `annotation_check` in this repository. 
