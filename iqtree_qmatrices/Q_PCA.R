...
# I apologise for using this, but needs must. Set this to your own directory to replicate
setwd("/Users/roblanfear/Dropbox/Projects_Current/dros_phylogenomics/BUSCO/07_Analysis/02_cleaned/02_iqtree_gene_aa/PCA")
...
filenames = c(nuclear, mitochondrial, chloroplast, viral, taxon_specific)
