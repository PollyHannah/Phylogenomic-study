...
1. The **73** GenBank (.gb) files before the stop codon check can be found in this repository at `annotation_check_results`/`1_genomes_before_stop_codon_check`.
...
2. The **70** Genbank (.gb) files post stop codon check can be found in this repository at `annotation_check_results`/`1_genomes_post_stop_codon_check`.
3. The **70** Genbank (.gb) files as lists of annotations post stop codon check can be found in this repository at `annotation_check_results`/`3_annotations_post_stop_codon_check`.
4. The **70** Genbank (.txt) files as lists of annotations post stop codon check can be found in this repository at `annotation_check_results`/`3_annotations_post_stop_codon_check`.
